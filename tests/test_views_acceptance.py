...
#Confiture app to use the testing database
...
class TestViews(unittest.TestCase):
	def setUp(self):
		...
		#Create a test user
		self.user = models.User(name="Edgar", email="edgar@example.com",
	...
	def tearDown(self):
		""" Test teardown """
		#Remove the tables and data from the testing database
	...
	def testLoginCorrect(self):
		...
		self.browser.fill("email", "edgar@example.com")
	...
	def testLoginIncorrect(self):
		self.browser.visit("http://0.0.0.0:8080/login")
		self.browser.fill("email", "gregory@example.com")
		self.browser.fill("password", "test")
		button = self.browser.find_by_css("button[type=submit]")
		button.click()
